...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ name: '', email: '', password: '', section: 'ISE 4A', designation: '' });
  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4">
      <form className="card w-full max-w-md space-y-3" onSubmit={onSubmit}>
        ...
        <div className="rounded-xl border p-2 text-sm text-slate-600">Account role: <span className="font-semibold">Student</span></div>
