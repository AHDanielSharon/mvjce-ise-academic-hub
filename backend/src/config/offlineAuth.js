...
import { approvedStaffAccounts, normalizeStaffEmail } from './staffRegistry.js';
...
export const listApprovedStaffAccounts = () => approvedStaffAccounts.map((account) => ({ ...account }));
